        ...
        data: function () {
            return {
                ...
                about: {
                    ...
                    eng: [
                        {paragraph: "During the early days of my childhood, I fell in love with video games and computers. My father bought our very first computer in 1998 and this is where my journey began. Not more than six years later, I built my first computer and administrated my first website. Since then I have arranged and organized a bunch of LAN-party events of different scales, setting up and configurating both network and servers."},
                        {paragraph: "In Uddevalla, where I grew up, I studied information technology in high school, but it wasn’t until I began study at University West, that I got in contact with actual software development. I graduated in July 2014 and got my first employment at CGI in early 2015. I have since then had the gathered experience within the IT business and from different techniques, design patterns and software languages."},
                        {paragraph: "Until June 2017 I was a part of the team that managed, developed and maintained the majority of all applications, for one on CGI:s biggest clients – DB Schenker. Shortly after I moved to Lidköping, I was employed at Evry and became a part of a team, whom maintained and developed multiple applications, for a lot of different clients."},
                        {paragraph: "After a short period of time, not more than a year, I grew tired of working as a consultant for a big company and got headhunted to Silverspin AB in Skövde. I still work at Silverspin to this day and I’ve been given the opportunity to really focus on improving the quality of the code for a single platform. At Silverspin I’m working in the online gambling business with focus on integrations towards different game providers – working with techniques such as Java, SQL and PHP."},
                        {paragraph: "My main area of expertise is within web development, primarily backend and API heavy work. I also have great experience with SQL and document-oriented databases."},
                        {paragraph: "Finally, I just want to highlight and point out that I have a broad technical interest and will approach every new given challenge with and open mind. I’m willing to work hard to meet my client’s expectations and deliver maintainable and well thought out software."}
                    ]
                }
            }
        },
